...
public class ParkedState implements IPilotActions{
    ...
    public void pilotFlies(F16 f16) {
        throw new UnsupportedOperationException("can't fly from this state");
    }
    ...
    public void pilotLands(F16 f16) {
        throw new UnsupportedOperationException("can't enter landing state");
    }

    @Override
    public void pilotParks(F16 f16) {
        throw new UnsupportedOperationException("can't enter parking state");
    }
}
